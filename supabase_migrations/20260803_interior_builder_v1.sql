-- Followville homeowner interior builder v1.
-- Preserves every existing claim and exterior customization. The RPC accepts
-- only the local catalog IDs and bounded quarter-grid transforms.
