...
2026-08-03 - Cade (via Windows Codex) - [WEB] Replaced the primitive claimed-home room with a polished enclosed low-poly interior and owner-only 25-item furnishing builder for desktop/landscape phone, hardened and applied version-2 interior persistence without changing any of 40 claims across 39 accounts, and passed focused visual/interaction QA while leaving Day 32, population 656, all 717 world records, Blender, and GLBs unchanged; the website candidate remains local and undeployed.
