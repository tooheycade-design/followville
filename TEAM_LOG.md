...
2026-08-01 - Zach (via Mac Codex) - [WEB] Replaced the Fishing Pond's rapid-click reel with a polished vertical momentum game: hold/Space accelerates a glowing catch zone upward, release and bottom bounce carry it downward, overlap fills a visible catch meter, and the unchanged Common/Uncommon/Rare/Legendary/Mythical tiers now drive distinct bar sizes, colors, crowns, difficulty, and smooth/mixed/sinker/floater/dart fish motion; passed a full automated catch plus desktop and landscape-phone visual review without adding inventory or changing city state, GLBs, Blender, claims, or Supabase.
