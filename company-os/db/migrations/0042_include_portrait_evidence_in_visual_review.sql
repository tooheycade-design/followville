-- The final portrait sidecars exposed a handoff gap: JPEG evidence was stored
-- safely but omitted from the Design Director manifest. Allow one final,
-- bounded visual revision after the corrected manifest ships.
...
begin
  ...
  if not found
     ...
     or v_task.review_cycle_count >= 6
     or not (
